...
This directory contains some examples of using the Go Tenant Security Client (TSC) SDK to protect sensitive data.
...
Once the TSP and LD are running, you can experiment with the example Go programs. Each of the subdirectories contains
...
By default, an example will use the `tenant-gcp-l` tenant. If you would like to experiment with a different tenant, just do:
